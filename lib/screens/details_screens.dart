...
class _DetailScreensState extends State<DetailsScreens> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor: widget.hero.warna,
        body: Stack(children: [
          Container(
              ...
              child: SafeArea(
                ...
                child: Center(
                  child: ClipRRect(
                    ...
                    child: Image.asset(widget.hero.imageAssets),
                  ),
                ),
              ))),
          SafeArea(
